...
class Ion_auth_model extends CI_Model
{
	...
	public function set_session($user)
	{
		...
		$groups = $this->db->get_where('users_groups ug',array('user_id'=>$user->id))->result_array();
		$newarray = array();
		foreach($groups as $group){
			array_push($newarray,$group['name']);
		}
	...
	{
		$query = $this->db->query('select name,b_id from branch');
		return $query;	
	}
